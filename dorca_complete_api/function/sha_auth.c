...
int SHAAUTH_FROM_DORCA()
{
	...
	GID[0] = 0;//GID_EEPROM_DATA[3];
	GID[1] = 0;//GID_EEPROM_DATA[2];
	GID[2] = 0;//GID_EEPROM_DATA[1];
	GID[3] = 0;//GID_EEPROM_DATA[0];	
...
int SHAAUTH_FROM_MCU()
{
	...
	unsigned char BKUP_ADDR = 0;
	int iResult = 0;
	unsigned char addr[2] = {0xeb,0xc0} ;
